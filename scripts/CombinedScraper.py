...
DB_HOST = "localhost"
DB_DATABASE = "drop-shop"
DB_USER = "root"
DB_PASSWORD = "dropshop12345"
...
def scrape_product_properties(targetUrls):
    ...
    if len(jsonData['name']) >= 50:
        jsonData['name'] = jsonData['name'][:47] + "..."
...
def get_mysql_query(action, shoe_props):
    ...
    #print(formatted_now)
    if (action == "insert"):
        SQL_Insert_Query = "INSERT INTO products (links_id, brand_name, product_name, model_num, product_description, release_date, img_file_path, collab_name, lowest_goat_price, lowest_fc_price, lowest_kix_price, created_at, updated_at)"
        SQL_Insert_Query += "VALUES ({}, \"{}\", \"{}\", \"{}\", \"{}\", \"{}\", \"{}\", \"{}\", {}, {}, {}, \"{}\", \"{}\" )".format(
            shoe_props["links_id"],
            shoe_props["brandName"],
            shoe_props["productName"][:50].replace('"', '\\"').replace('(','').replace(')',''),
            shoe_props["modelNum"],
        ...
        SQL_Update_Query = "UPDATE products SET links_id = \"{}\", brand_name = \"{}\", product_name = \"{}\", model_num = \"{}\", product_description = \"{}\", release_date = \"{}\", img_file_path = \"{}\", collab_name = \"{}\", lowest_goat_price = {}, lowest_fc_price = {}, lowest_kix_price = {}, created_at = \"{}\", updated_at = \"{}\""
        ...
        SQL_Update_Query += " WHERE img_file_path = \"{}\"".format(shoe_props["imgFilePath"])
