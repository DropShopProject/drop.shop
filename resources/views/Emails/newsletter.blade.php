                                  ...
                                  <tr>
                                    <td style="border: 0; border-collapse: collapse; margin: 0 auto; padding:0; display: inline-block" align="center" width="640">
                                      ...
                                      <tbody>
                                        <tbody>
                                          <tr>
                                            <td style="padding:0; background-color: #E5D5B4">
                                              <table style="border-collapse: collapse" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                  <td style="border-collapse: collapse; padding: 15px 0px; width: 100%" align="center" bgcolor="#E5D5B4">
                                                    <table style="border-collapse: collapse" border="0" width="640" cellspacing="0" cellpadding="0">
                                                      <tbody>
                                                        <tr>
                                                          <td style="padding-left: 40px; background-color: #e5d5b4; text-align: center;"><a href="https://www.facebook.com/DropShop-101779201616820" target="_blank" rel="noopener"><img class="fbook-logo" style="height: 40px; width: 40px; padding-right: 40px;" src="https://img.icons8.com/ios-glyphs/50/000000/facebook-f.png" /></a><a href="https://twitter.com/DropShop4935" target="_blank" rel="noopener"><img class="twitter-logo" style="height: 40px; width: 40px; padding-right: 40px;" src="https://img.icons8.com/ios-filled/50/000000/twitter.png" /></a><a href="https://instagram.com/dropshop4935?igshid=1ci1k571w1da5" target="_blank" rel="noopener"><img class="insta-logo" style="padding-right: 40px; height: 40px; width: 40px;" src="https://img.icons8.com/ios-filled/50/000000/instagram.png" /></a></td>
                                                        </tr>
                                                        <tr>
                                                          <td style="background-color: #e5d5b4; text-align: center; font-size: 14px;">Derived From The Community, For The Community.</td>
                                                        </tr>
                                                        <tr>
                                                          <td style="background-color: #e5d5b4; text-align: center; font-size: 14px;">DropShop Project 2020 Copyright</td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  </td>
